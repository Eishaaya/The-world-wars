...
namespace The_world_wars_Game
{
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            marching = Content.Load<SoundEffect>("Marching");
            music = Content.Load<Song>("Music");
            gun = Content.Load<SoundEffect>("gun");
            gunsound = gun.CreateInstance();
            tankmove = Content.Load<SoundEffect>("Tankmoving");
            ...
            german = new moving_sprite(Content.Load<Texture2D>("german"), new Vector2(-200, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(2, 0), 5, 3, 5, new TimeSpan(0, 0, 0, 0, 50), false);
            german.range = new Rectangle((int)german.Location.X - german.Image.Width, (int)german.Location.Y, 300, 30);
            italy = new moving_sprite(Content.Load<Texture2D>("italy"), new Vector2(-200, rand.Next(700, GraphicsDevice.Viewport.Height - 114)), Color.White, new Vector2(3, 0), 150, 20, 150, new TimeSpan(0, 0, 0, 0, 350), false);
            ...
            jeepbutton = new button(Content.Load<Texture2D>("jeepbutton"), new Vector2(GraphicsDevice.Viewport.Width - 144, 0), Color.White, 500);
            wallbutton = new button(Content.Load<Texture2D>("wallbutt"), new Vector2(GraphicsDevice.Viewport.Width - 544, 0), Color.White, 30000);
            ...
            werdbut1 = new button(Content.Load<Texture2D>("1b"), new Vector2(GraphicsDevice.Viewport.Width - 904, 0), Color.White, 600);
            werdbutt2 = new button(Content.Load<Texture2D>("2b"), new Vector2(GraphicsDevice.Viewport.Width - 904, 450), Color.White, 120);
            werdbutt3 = new button(Content.Load<Texture2D>("3b"), new Vector2(GraphicsDevice.Viewport.Width - 904, 200), Color.White, 175);
            werdbutt4 = new button(Content.Load<Texture2D>("4b"), new Vector2(GraphicsDevice.Viewport.Width - 904, 300), Color.White, 190);
            werdbutt5 = new button(Content.Load<Texture2D>("5b"), new Vector2(GraphicsDevice.Viewport.Width - 904, 700), Color.White, 3000);
            slowbutt = new button(Content.Load<Texture2D>("slowbutt"), new Vector2(GraphicsDevice.Viewport.Width - 504, 600), Color.White, 200);
            truckbutton = new button(Content.Load<Texture2D>("truckbutt"), new Vector2(GraphicsDevice.Viewport.Width - 144, 605), Color.White, 5000);
            ...
            truckbutton2 = new button(Content.Load<Texture2D>("truck2"), new Vector2(GraphicsDevice.Viewport.Width - 144, 665), Color.White, 1500);
            ...
            uspbutt = new button(Content.Load<Texture2D>("uspb"), new Vector2(GraphicsDevice.Viewport.Width - 344, 205), Color.WhiteSmoke, 1450);
            helibutt = new button(Content.Load<Texture2D>("Helibutt"), new Vector2(GraphicsDevice.Viewport.Width - 344, 270), Color.WhiteSmoke, 1000);
            mechbutt = new button(Content.Load<Texture2D>("mechbutt"), new Vector2(GraphicsDevice.Viewport.Width - 564, 250), Color.White, 10000);
            officerbutton = new button(Content.Load<Texture2D>("officerbutton"), new Vector2(GraphicsDevice.Viewport.Width - 108, 50), Color.White, 10);
            halobutton = new button(Content.Load<Texture2D>("halobutt"), new Vector2(GraphicsDevice.Viewport.Width - 144, 120), Color.White, 75);
            medicbutton = new button(Content.Load<Texture2D>("halfbutton"), new Vector2(GraphicsDevice.Viewport.Width - 144, 360), Color.White, 75000);
            armorcarbutton = new button(Content.Load<Texture2D>("armcarbutton"), new Vector2(GraphicsDevice.Viewport.Width - 124, 280), Color.White, 500);
            wwibutton = new button(Content.Load<Texture2D>("wwibutton"), new Vector2(GraphicsDevice.Viewport.Width - 174, 531), Color.White, 475);
            firstbutton = new button(Content.Load<Texture2D>("firstbutton"), new Vector2(GraphicsDevice.Viewport.Width - 174, 480), Color.White, 350);
            lightbutton = new button(Content.Load<Texture2D>("lightbutton"), new Vector2(GraphicsDevice.Viewport.Width - 84, 120), Color.White, 200);
            cruisebutton = new button(Content.Load<Texture2D>("cruisebutton"), new Vector2(GraphicsDevice.Viewport.Width - 154, 200), Color.White, 2500);
            lancasterbutton = new button(Content.Load<Texture2D>("lanbutton"), new Vector2(GraphicsDevice.Viewport.Width - 144, 410), Color.White, 750);
            soldierbutton = new button(Content.Load<Texture2D>("soldierbutton"), new Vector2(GraphicsDevice.Viewport.Width - 44, 50), Color.White, 5);
            clouds = new sprite(Content.Load<Texture2D>("clouds"), new Vector2(0, 0), Color.White);
            grenade = new moving_sprite(Content.Load<Texture2D>("granader"), new Vector2(-200, rand.Next(700, GraphicsDevice.Viewport.Height - 89)), Color.White, new Vector2(2, 0), 7, 6, 15, new TimeSpan(0, 0, 0, 0, 300), false);
            grenade.range = new Rectangle((int)grenade.Location.X - grenade.Image.Width, (int)grenade.Location.Y, 200, 30);
            lighttank = new moving_sprite(Content.Load<Texture2D>("lightitaly"), new Vector2(-200, rand.Next(700, GraphicsDevice.Viewport.Height - 90)), Color.White, new Vector2(4, 0), 75, 10, 80, new TimeSpan(0, 0, 0, 0, 325), false);
            lighttank.range = new Rectangle((int)lighttank.Location.X - lighttank.Image.Width, (int)lighttank.Location.Y, 250, 30);
            Long = new moving_sprite(Content.Load<Texture2D>("long"), new Vector2(-300, rand.Next(700, GraphicsDevice.Viewport.Height - 118)), Color.White, new Vector2(1, 0), 1000, 50, 1000, new TimeSpan(0, 0, 0, 0, 700), false);
            Long.range = new Rectangle((int)Long.Location.X - Long.Image.Width, (int)Long.Location.Y, 650, 30);
            carmor = new moving_sprite(Content.Load<Texture2D>("carmor"), new Vector2(-200, rand.Next(700, GraphicsDevice.Viewport.Height - 119)), Color.White, new Vector2(4, 0), 150, 25, 175, new TimeSpan(0, 0, 0, 0, 450), false);
            carmor.range = new Rectangle((int)carmor.Location.X - carmor.Image.Width, (int)carmor.Location.Y, 600, 30);
            panzer = new moving_sprite(Content.Load<Texture2D>("panzer"), new Vector2(-200, rand.Next(700, GraphicsDevice.Viewport.Height - 120)), Color.White, new Vector2(2, 0), 800, 40, 800, new TimeSpan(0, 0, 0, 0, 550), false);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (iflose == false && ifwin == false)
            {
                if (elapsedgerman >= untilgerman)
                {
                    ...
                    moving_sprite newGerman = new moving_sprite(Content.Load<Texture2D>("german"), new Vector2(-1000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(2, 0), 5, 1, 5, TimeSpan.FromMilliseconds(200), false);
                ...
                if (elapsedair >= untilair)
                {
                    ...
                    moving_sprite newGerman = new moving_sprite(Content.Load<Texture2D>("air"), new Vector2(-1000, rand.Next(0, 700)), Color.White, new Vector2(2, 0), 2500, 0, 2500, TimeSpan.FromMilliseconds(500), true);
                ...
                if (elapseditaly >= untilitaly)
                {
                    ...
                    moving_sprite newItaly = new moving_sprite(Content.Load<Texture2D>("italy"), new Vector2(-1000, rand.Next(700, GraphicsDevice.Viewport.Height - 114)), Color.White, new Vector2(3, 0), 350, 25, 150, TimeSpan.FromMilliseconds(350), false);
                ...
                if (untilgrenade <= elapsedgrenade)
                {
                    ...
                    moving_sprite newGrenade = new moving_sprite(Content.Load<Texture2D>("granader"), new Vector2(-1000, rand.Next(700, GraphicsDevice.Viewport.Height - 89)), Color.White, new Vector2(2, 0), 7, 5, 15, TimeSpan.FromMilliseconds(300), false);
                ...
                if (elapsedlighttank >= untillighttank)
                {
                    ...
                    moving_sprite newLighttank = new moving_sprite(Content.Load<Texture2D>("lightitaly"), new Vector2(-1000, rand.Next(700, GraphicsDevice.Viewport.Height - 90)), Color.White, new Vector2(4, 0), 175, 12, 80, TimeSpan.FromMilliseconds(325), false);
                ...
                if (elapsedpanzer >= untilpanzer)
                {
                    ...
                    moving_sprite newPanzer = new moving_sprite(Content.Load<Texture2D>("panzer"), new Vector2(-1000, rand.Next(700, GraphicsDevice.Viewport.Height - 120)), Color.White, new Vector2(2, 0), 2000, 50, 500, TimeSpan.FromMilliseconds(500), false);
                ...
                if (waitsuper >= untilsuper)
                {
                    ...
                    moving_sprite newPanzer = new moving_sprite(Content.Load<Texture2D>("super"), new Vector2(-1000, rand.Next(700, GraphicsDevice.Viewport.Height - 120)), Color.White, new Vector2(2.5f, 0), 100000, 400, 50000, TimeSpan.FromMilliseconds(2000), false);
                ...
                if (elapsedlong >= untillong)
                {
                    ...
                    moving_sprite newLong = new moving_sprite(Content.Load<Texture2D>("long"), new Vector2(-1F, rand.Next(700, GraphicsDevice.Viewport.Height - 118)), Color.White, new Vector2(1, 0), 4000, 50, 1000, TimeSpan.FromMilliseconds(600), false);
                ...
                if (untilcarmor <= elapsedcarmor)
                {
                    ...
                    moving_sprite newCarmor = new moving_sprite(Content.Load<Texture2D>("carmor"), new Vector2(-1000, rand.Next(700, GraphicsDevice.Viewport.Height - 119)), Color.White, new Vector2(3, 0), 350, 50, 175, TimeSpan.FromMilliseconds(500), false);
                ...
                if (jeepbutton.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= jeepbutton.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("jeep"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-5, 0), 60, 25, 5, TimeSpan.FromMilliseconds(400), false);
                ...
                if (helibutt.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= helibutt.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("heli"), new Vector2(3000, rand.Next(0, GraphicsDevice.Viewport.Height - 100)), Color.White, new Vector2(-6, 0), 800, 10, 2, TimeSpan.FromMilliseconds(2), false);
                    Money -= helibutt.cost;
                    newjeep.willflip = false;
                ...
                if (uspbutt.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= uspbutt.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("usp"), new Vector2(3000, rand.Next(0, GraphicsDevice.Viewport.Height - 100)), Color.White, new Vector2(-17.5f, 0), 1250, 150, 5, TimeSpan.FromMilliseconds(100), false);
                    Money -= uspbutt.cost;
                    newjeep.willflip = false;
                    newjeep.range = new Rectangle((int)newjeep.Location.X, (int)newjeep.Location.Y, 400, 30);
                    newjeep.istank = true;
                ...
                {
                    allies newjeep = new allies(Content.Load<Texture2D>("cavalry"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-5, 0), 30, 1, 5, TimeSpan.FromMilliseconds(10), false);
                ...
                if (mechbutt.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= mechbutt.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("mech"), new Vector2(3000, rand.Next(300, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-7, 0), 10000, 300, 0, TimeSpan.FromMilliseconds(200), false);
                    Money -= mechbutt.cost;
                    newjeep.ifmech = true;
                ...
                if (werdbut1.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= werdbut1.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("1"), new Vector2(3000, rand.Next(350, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-2.6f, 0), 1000, 35, 0, TimeSpan.FromMilliseconds(250), false);
                    Money -= werdbut1.cost;
                ...
                if (werdbutt2.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= werdbutt2.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("2"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-1.5f, 0), 500, 3, 0, TimeSpan.FromMilliseconds(1), false);
                ...
                if (werdbutt3.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= werdbutt3.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("3"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-2, 0), 650, 15, 0, TimeSpan.FromMilliseconds(450), false);
                ...
                if (werdbutt4.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= werdbutt4.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("4"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-1.5f, 0), 500, 15, 0, TimeSpan.FromMilliseconds(150), false);
                ...
                if (werdbutt5.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= werdbutt5.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("5"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-4.5f, 0), 3500, 50, 0, TimeSpan.FromMilliseconds(130), false);
                ...
                if (slowbutt.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= slowbutt.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("slow"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-1.5f, 0), 550, 47, 0, TimeSpan.FromMilliseconds(400), false);
                    Money -= slowbutt.cost;
                    newjeep.range = new Rectangle((int)newjeep.Location.X, (int)newjeep.Location.Y , 400, 30);
                    newjeep.istank = true;
                    allies.Add(newjeep);
                ...
                if (jeepbutton2.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= jeepbutton2.cost)
                {
                    ...
                    allies newjeep = new allies(Content.Load<Texture2D>("jeep2"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-5, 0), 400, 1, 5, TimeSpan.FromMilliseconds(30), false);
                ...
                if (tommybutt.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= tommybutt.cost)
                {
                    ...
                    allies.Add(newjeep);
                    allies newsoldier = new allies(Content.Load<Texture2D>("soldier"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-2, 0), 5, 1, 5, new TimeSpan(200), false);
                    newsoldier.range = new Rectangle((int)newsoldier.Location.X, (int)newsoldier.Location.Y, 300, 15);
                    allies.Add(newsoldier);
                    allies newofficer = new allies(Content.Load<Texture2D>("officer"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-2, 0), 12, 2, 5, new TimeSpan(160), false);
                    newofficer.range = new Rectangle((int)newofficer.Location.X, (int)newofficer.Location.Y, 350, 15);
                    allies.Add(newofficer);
                    allies newsoldier2 = new allies(Content.Load<Texture2D>("soldier"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-2, 0), 5, 1, 5, new TimeSpan(200), false);
                    newsoldier.range = new Rectangle((int)newsoldier.Location.X, (int)newsoldier.Location.Y, 300, 15);
                    allies.Add(newsoldier2);
                    allies newofficer2 = new allies(Content.Load<Texture2D>("officer"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-2, 0), 12, 2, 5, new TimeSpan(160), false);
                    newofficer.range = new Rectangle((int)newofficer.Location.X, (int)newofficer.Location.Y, 350, 15);
                    allies.Add(newofficer2);
                    allies.Add(newsoldier2);
                    allies newofficer3 = new allies(Content.Load<Texture2D>("halo"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-3, 0), 45, 2, 15, new TimeSpan(200), false);
                    newofficer.range = new Rectangle((int)newofficer.Location.X, (int)newofficer.Location.Y, 350, 15);
                ...
                {
                    allies newtruck = new allies(Content.Load<Texture2D>("truck"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-4, 0), 100, 0, 5, TimeSpan.FromMilliseconds(1000), false);
                    allies newtruck3 = new allies(Content.Load<Texture2D>("radarbutton"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-2, 0), 90, 0, 5, TimeSpan.FromMilliseconds(1000), false);
                    newtruck.willflip = true;
                ...
                if (medicbutton.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= medicbutton.cost)
                {
                    ...
                    medics.Add(new moving_sprite(Content.Load<Texture2D>("medic"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-1, 0), 50, 10, 5, new TimeSpan(70), false));
                }
                if (armorcarbutton.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= armorcarbutton.cost)
                {
                    ...
                    allies newarmorcar = new allies(Content.Load<Texture2D>("armcar"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-3, 0), 250, 23, 5, new TimeSpan(500), false);
                ...
                if (lightbutton.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= lightbutton.cost)
                {
                    ...
                    allies newlight = new allies(Content.Load<Texture2D>("light"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-3, 0), 80, 7, 5, new TimeSpan(350), false);
                ...
                if (firstbutton.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= firstbutton.cost)
                {
                    ...
                    allies newfirst = new allies(Content.Load<Texture2D>("first"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-1.5f, 0), 450, 10, 5, new TimeSpan(600), false);
                ...
                if (wwibutton.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= wwibutton.cost)
                {
                    ...
                    allies newwwi = new allies(Content.Load<Texture2D>("wwi"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-1.5f, 0), 650, 15, 5, TimeSpan.FromMilliseconds(500), false);
                ...
                if (cruisebutton.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= cruisebutton.cost)
                {
                    ...
                    allies newcruise = new allies(Content.Load<Texture2D>("cruise"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-2, 0), 3560, 150, 5, TimeSpan.FromMilliseconds(300), false);
                ...
                if (lancasterbutton.Hitbox.Intersects(cursor.Hitbox) && ms.LeftButton == ButtonState.Pressed && lastMs.LeftButton == ButtonState.Released && Money >= lancasterbutton.cost)
                {
                    ...
                    allies newlancaster = new allies(Content.Load<Texture2D>("Lancaster"), new Vector2(3000, rand.Next(700, GraphicsDevice.Viewport.Height - 92)), Color.White, new Vector2(-3, 0), 400, 30, 5, TimeSpan.FromMilliseconds(350), false);
                        ...
                        if (allies[p].inshootzone)
                        {
                            ...
                            if (enemies[i].range.Intersects(allies[p].Hitbox))
                            {
                                if (allies[p].health <= 0)
                                {
                                    ...
                                    {
                                        allies[p].Image = Content.Load<Texture2D>("boom");
                                ...
                                else
                                {
                                    ...
                                    if(enemies[i].isbomber == true && enemies[i].wait >= enemies[i].tillshoot)
                                    {
                                        ...
                                        moving_sprite newPanzer = new moving_sprite(Content.Load<Texture2D>("bomb"), enemies[i].Location, Color.White, new Vector2(0, 15), 1000, 500, 1, TimeSpan.FromMilliseconds(0), false);
                        ...
                        if (enemies[i].inshootzone)
                        {
                            if (allies[p].range.Intersects(enemies[i].Hitbox))
                            {
                                ...
                                if (enemies[i].health <= 0)
                                {
                                    ...
                                    {
                                        enemies[i].Image = Content.Load<Texture2D>("boom");
                                    }
                                ...
                                else
                                {
                                    ...
                                    if (allies[p].wait >= allies[p].tillshoot)
                                    {
                                        ...
                                        {
                                            allies[p].wait = TimeSpan.Zero;
                                            allies newPanzer = new allies(Content.Load<Texture2D>("bomb"), allies[p].Location, Color.White, new Vector2(0, 15), 1000, 500, 1, TimeSpan.FromMilliseconds(0), false);
                                            newPanzer.range = new Rectangle((int)newPanzer.Location.X - newPanzer.Image.Width, (int)newPanzer.Location.Y, 1, 1);
                                            newPanzer.istank = true;
                                            newPanzer.ifbomb = true;
                                        ...
                                        {
                                            allies newsoldier = new allies(Content.Load<Texture2D>("soldier"), new Vector2(allies[p].Location.X, allies[p].Location.Y), Color.White, new Vector2(-2, 0), 3, 1, 5, new TimeSpan(200), false);
                                            newsoldier.range = new Rectangle((int)newsoldier.Location.X, (int)newsoldier.Location.Y, 300, 30);
                                            allies.Add(newsoldier);
                                            allies newofficer = new allies(Content.Load<Texture2D>("officer"), new Vector2(allies[p].Location.X, allies[p].Location.Y), Color.White, new Vector2(-2, 0), 7, 2, 5, new TimeSpan(160), false);
                                            newofficer.range = new Rectangle((int)newofficer.Location.X, (int)newofficer.Location.Y, 350, 30);
                                            allies.Add(newofficer);
                                            ...
                                            newjeep.range = new Rectangle((int)newjeep.Location.X, (int)newjeep.Location.Y, 600, 30);
                                            allies.Add(newjeep);
                                            allies newjeep2 = new allies(Content.Load<Texture2D>("cavalry"), new Vector2(allies[p].Location.X, allies[p].Location.Y), Color.White, new Vector2(-5, 0), 30, 1, 5, TimeSpan.FromMilliseconds(10), false);
                                        ...
                                        {
                                            allies newmoto = new allies(Content.Load<Texture2D>("moto"), new Vector2(allies[p].Location.X, allies[p].Location.Y), Color.White, new Vector2(-6, 0), 120, 1, 5, new TimeSpan(30), false);
